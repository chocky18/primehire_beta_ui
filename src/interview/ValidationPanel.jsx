...
// // export default function ValidationPanel() {
// //     /* =====================================================
// //        🔒 HARD EXIT — NEVER RENDER AFTER INTERVIEW STARTS
// //     ===================================================== */
...
// //     }, []);
// //     /* =====================================================
// //        STEP 1: VALIDATE ACCESS (ONLY ONCE)
// //     ===================================================== */
// //     useEffect(() => {
// //         if (!candidateId || !jdId || !interviewToken) {
// //             setAccessState("error");
...
// //     return (
// //         <div className="vp-container">
// //             <img src={logo} alt="logo" className="vp-logo" />
// //             <h2>Candidate Validation</h2>
...
//     ===================================================== */
//     useEffect(() => {
//         if (sessionStorage.getItem(INTERVIEW_FLAG) === "true") {
//             navigate("/interview", { replace: true });
//         }
//     }, []);

//     /* =====================================================
//        🔐 Validate interview access (ONCE)
//     ===================================================== */
//     useEffect(() => {
//         if (!candidateId || !jdId || !interviewToken) {
//             setAccessState("error");
...
//             setPanMessage(
//                 d?.validation?.valid_name
//                     ? "PAN verified"
//                     : d?.validation?.message || "PAN validation failed"
//             );
//         } catch {
//             setPanMessage("PAN validation error");
//         }
...
export default function ValidationPanel() {
    ...
    /* ================= STATE ================= */
    const [accessState, setAccessState] = useState("checking"); // checking | allowed | early | expired | error
    const [slot, setSlot] = useState(null);
    const [errorMsg, setErrorMsg] = useState("");
    ...
    if (accessState === "checking")
        return (
            <div className="vp-state">
                <h2>🔒 Checking interview window…</h2>
            </div>
        );
    ...
    return (
        <div className="vp-container">
            {/* LOGO */}
            <div className="vp-logo-header">
                <img src={logo} className="vp-logo" alt="PrimeHire" />
            </div>

            <div className="vp-card">
                <div className="vp-title">Candidate Validation</div>
                ...
                <div className="vp-field">
                    ...
                    {panFile && (
                        <Button className="vp-primary" onClick={validatePanCard}>
                            Validate PAN
                        </Button>
                    )}
                    ...
                    {panMessage && (
                        <div
                            className={`vp-pan-status ${panMessage.includes("verified") ? "success" : "error"
                                }`}
                        >
                            {panMessage}
                        </div>
                ...
                <div className="vp-camera">
                    <div className="vp-camera-box" onClick={startCamera}>
                        {capturedImage ? (
                        ...
                        <div className="vp-camera-overlay">
                            Click to {capturedImage ? "retake" : "start"} camera
                        </div>
                    ...
                    <div className="vp-actions">
                        <Button onClick={startCamera}>Start Camera</Button>
                        <Button onClick={captureFace}>Capture Photo</Button>
                        <Button className="vp-primary" onClick={saveFaceToBackend}>
                            Save Face
                        </Button>

                        <Button
                            className="vp-continue"
                            disabled={!isSaved || !attemptId}
                            onClick={handleContinue}
                        >
                            Continue →
                        </Button>
